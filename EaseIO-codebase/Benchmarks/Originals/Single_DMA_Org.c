...
/*@SAAD: The DMA_copy is different from EASEIO_DMA_COPY. Just consider it as an ordinary IO function.*/
void task_dma()
{
        while (exe_number<1000) {

            call_IO(DMA_copy(&dma_data_dst[0], &dma_data_src[0], ARR_SIZE),"Single");
